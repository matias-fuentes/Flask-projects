const paddingToggle = document.querySelector('#name-container');
...
name.addEventListener('focusout', function() {
    ...
    paddingToggle.classList.toggle('name-container');
});

/* Updates the month's days limit, and handle if the user first inputs a day (e.g. 31), and then, an invalid month for that day (e.g. february),
since February 31st it's an invalid date. */
...
months.addEventListener('change', function() {
    ...
    else if (months.value === 'April' || months.value === 'June' || months.value === 'September' || months.value === 'November') {
        if (days.value > 29) {
